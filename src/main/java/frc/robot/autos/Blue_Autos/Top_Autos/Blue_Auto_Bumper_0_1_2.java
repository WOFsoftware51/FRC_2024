...
public class Blue_Auto_Bumper_0_1_2 extends SequentialCommandGroup {

    public Blue_Auto_Bumper_0_1_2(Swerve swerve, Turret turret, Shooter shooter, Auton_Subsystem aSub, Transfer_Intake transfer, Intake intake){
        ...
        addCommands(
            ...
            new ParallelRaceGroup(
                new Transfer_IntakeCommand(transfer),
                new IntakeCommand(intake),
                swerve.followTrajectoryCommand("Blue_Top_Bumper_1_2", false)
            ),
            new ParallelRaceGroup(
                new TurretAim_Auton(turret),
                new AutonSwerveAim(swerve, ()-> 0.0, ()-> 0.0)
