...
public class Red_Auto_Bumper_0_8_7 extends SequentialCommandGroup {

    public Red_Auto_Bumper_0_8_7(Swerve swerve, Turret turret, Shooter shooter, Auton_Subsystem aSub, Transfer_Intake transfer, Intake intake){
        ...
        addCommands(
            ...
            new ParallelRaceGroup(
                new Transfer_IntakeCommand(transfer),
                new IntakeCommand(intake),
                new PathPlannerAuto("Red_8_Far_7")
            ),
            new PathPlannerAuto("Red_Bottom_Bumper_7_Shoot"),
            new ParallelRaceGroup(
                new TurretAim_Auton(turret),
                new AutonSwerveAim(swerve, ()-> 0.0, ()-> 0.0)
            ),
