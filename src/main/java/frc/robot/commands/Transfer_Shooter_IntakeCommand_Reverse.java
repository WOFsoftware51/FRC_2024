...
public class Transfer_Shooter_IntakeCommand_Reverse extends Command {    
    public Transfer_Intake m_intake;   
    public DoubleSupplier joystick;
    // private Timer timer;

    public Transfer_Shooter_IntakeCommand_Reverse(Transfer_Intake intake) {
