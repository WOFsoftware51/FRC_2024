...
public class Red_Auto_Bumper_0_1_5 extends SequentialCommandGroup {

    public Red_Auto_Bumper_0_1_5(Swerve swerve, Turret turret, Shooter shooter, Auton_Subsystem aSub, Transfer_Intake transfer, Intake intake){
        ...
        addCommands(
            ...
            new PathPlannerAuto("Red_Top_Bumper_5_0"), 
            new ParallelRaceGroup(
                new Auton_Wait(125),
                aSub.auton_Shoot(transfer)
            ),
