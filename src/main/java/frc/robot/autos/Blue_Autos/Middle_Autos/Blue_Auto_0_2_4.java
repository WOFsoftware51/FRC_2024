...
public class Blue_Auto_0_2_4 extends SequentialCommandGroup {
    ...
    public Blue_Auto_0_2_4(Swerve swerve, Turret turret, Shooter shooter, Auton_Subsystem aSub, Transfer_Intake transfer, Intake intake){
        ...
        addCommands(
            ...
            new ParallelRaceGroup(
                ...
                new SequentialCommandGroup(
                    ...
                    new PathPlannerAuto("Blue_2_4"),
                    new PathPlannerAuto("Blue_4_2"),
                    aSub.auton_Score(turret, transfer, shooter, Constants.AutonTurretPositions.Middle.Position_2)
                )
            )
        );    
