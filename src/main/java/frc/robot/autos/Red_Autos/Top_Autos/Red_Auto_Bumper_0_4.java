...
public class Red_Auto_Bumper_0_4 extends SequentialCommandGroup {

    public Red_Auto_Bumper_0_4(Swerve swerve, Turret turret, Shooter shooter, Auton_Subsystem aSub, Transfer_Intake transfer, Intake intake){
        ...
        addCommands(
            ...
            new PathPlannerAuto("Red_Top_Bumper_4_Far"),
            new ParallelRaceGroup(
