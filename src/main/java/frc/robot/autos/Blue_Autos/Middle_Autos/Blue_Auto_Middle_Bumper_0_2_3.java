...
public class Blue_Auto_Middle_Bumper_0_2_3 extends SequentialCommandGroup {

    public Blue_Auto_Middle_Bumper_0_2_3(Swerve swerve, Turret turret, Shooter shooter, Auton_Subsystem aSub, Transfer_Intake transfer, Intake intake){
        
        addRequirements(swerve, turret, shooter, aSub, transfer, intake);

        ////////TODO Double chdeck paths later
        addCommands(
            ...
            new ParallelRaceGroup(
                new Transfer_IntakeCommand(transfer),
                new IntakeCommand(intake),
                swerve.followTrajectoryCommand("Blue_Middle_Bumper_0_3")
            ),
            new ParallelRaceGroup(
