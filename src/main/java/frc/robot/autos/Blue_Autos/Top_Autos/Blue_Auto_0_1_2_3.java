...
public class Blue_Auto_0_1_2_3 extends SequentialCommandGroup {

    public Blue_Auto_0_1_2_3(Swerve swerve, Turret turret, Shooter shooter, Auton_Subsystem aSub, Transfer_Intake transfer, Intake intake){
        ...
        addCommands(
            ...
            new ParallelRaceGroup(
                ...
                new SequentialCommandGroup(
                    ...
                    aSub.auton_Score(turret, transfer, shooter, Constants.AutonTurretPositions.Top.Position_3)
                )
            )
        );        
    }
